...
//Colocar todos los iconos importados en el "componente general" ya que muchos se repiten
...
function Portfolio() {
  ...
  <div class="container  col-5  rounded bg-dark row justify-content-center"  >
    <p class="h1 row justify-content-center text-light"  style={{ fontSize: "2.9rem",fontStyle:"italic" }} >{ProyectosTxt[0].titulo} </p>
    <h1 class="text-left display-8 fs-4" className="textoPortafolio">{ProyectosTxt[0].texto} </h1>
